    ...
    public ResponseEntity<?> bulkReservation(
        ...
        for (BulkReservation bulkReservation : br) {
            ...
            for (int i = startDay; i <= endDay; i++) {
                ...
                LocalDate dateToCompare = resultDate.toLocalDate();
                DayOfWeek dateToCompare2 = dateToCompare.getDayOfWeek();
                if (dateToCompare2 != DayOfWeek.SATURDAY && dateToCompare2 != DayOfWeek.SUNDAY)
                {
